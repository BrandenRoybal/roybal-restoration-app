...
| 📷 **Job Photos** | Before / during / after pictures with room + caption + auto timestamp; prints as a Photo Report. **Photo log PDF (email)** exports every photo full size, two per page, grouped before/during/after, in files under 10 MB each — the attachment a carrier reviewer can open (their intake flattens portal links to dead text). |

    ...
    <div className="min-h-screen bg-[#0A1628] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <form
          ...
          className="bg-[#0F172A] rounded-2xl border border-[#1E293B] p-8 space-y-5"
        >
          {error && (
          ...
          <div>
            ...
            <input
              ...
              required
              autoComplete="email"
              placeholder="branden@roybalrestoration.com"
              className="w-full bg-[#1E293B] border border-[#334155] rounded-xl px-4 h-12 text-slate-100 placeholder-slate-600 focus:outline-none focus:border-[#F97316] transition-colors"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#F97316] hover:bg-[#EA6C0C] disabled:opacity-60 text-white font-bold h-12 rounded-xl transition-colors flex items-center justify-center gap-2"
          >
            {loading ? (

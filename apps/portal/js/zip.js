/* ============================================================
   Roybal Portal — minimal ZIP writer (STORE method only)
   VERBATIM COPY of apps/field/js/zip.js (the portal deploys as
   its own static directory, so it can't import across apps —

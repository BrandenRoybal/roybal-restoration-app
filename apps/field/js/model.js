...
export const FORMS = [
  ...
  { key: "reconEstimates",   name: "Estimate", icon: "🏗️", multi: true,
    types: ["restoration", "construction"],
    blurb: "Proposed scope & pricing — drafted from your site visit (Magicplan report, photos, notes, recording) or the documented damage" },
